...
public class TestMenuFact02 {
    ...
    //TODO: Rechecker les states pour les etats de commmandes
    //TODO: Observer a mettre en
    ...
    public static void main(String[] args) {
        ...
        Menu m1 = new Menu("model.menufact.Menu 1");
        Menu m2 = new Menu("model.menufact.Menu 2");
   ...
   private void test2_AffichePlatsSante(boolean trace, PlatSante ps1, PlatSante ps2,
    ...
    private void test7_CreerFacture(Facture f1, Menu m1) throws FactureException, PlatsException
    {
    ...
    private void test8_AjouterPlatsFacture(Facture f1, Menu m1, int pos) throws PlatsException,MenuException,FactureException
    {
